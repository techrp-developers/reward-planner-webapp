...
export const BrandPartnersSection = () => {
  return (
    <section className="bg-white rounded-3xl border border-gray-200/80 p-4 sm:p-6 shadow-xs space-y-3.5 relative overflow-hidden">
      ...
      {/* SECTION HEADER */}
      <div className="relative z-10 text-center max-w-3xl mx-auto space-y-1.5">
      ...
      <div className="relative z-10 pt-1 overflow-hidden">
        ...
        <div className="relative overflow-hidden py-1.5 rounded-2xl bg-gray-50/60 border border-gray-100/90 shadow-2xs">
          <div
            className="animate-marquee flex items-center gap-8 py-2"
            style={{ animationDuration: '45s' }}
          >
            <img
              src={brandStrip1}
              alt="Brand Partners"
              className="h-11 sm:h-14 md:h-16 w-auto max-w-none shrink-0 opacity-90 hover:opacity-100 transition-opacity"
            />
            <img
              src={brandStrip2}
              alt="Brand Partners"
      ...
      <div className="relative z-10 pt-2 border-t border-gray-100 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-[11px] sm:text-xs font-semibold text-gray-500">
        <span className="flex items-center gap-1.5">
          <VerifiedOutlinedIcon sx={{ fontSize: 16 }} className="text-emerald-600" />
